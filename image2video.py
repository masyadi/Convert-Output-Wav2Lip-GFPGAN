...
restored_frames_path = input("Masukkan path image frame: ")
input_audio_path = input("Masukkan path audio: ")
processed_video_output_path = "results/" + Path(restored_frames_path).stem
